...
// Upstream #2036 moved every suite out of the repo root, so __dirname is
// tests/unit and no longer the root this path was written against.
const REPO_ROOT = path.resolve(__dirname, '..', '..');
const src = fs.readFileSync(path.join(REPO_ROOT, 'public', 'node-scopes.js'), 'utf8');
